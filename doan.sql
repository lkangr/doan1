...
(2, 'Bánh tráng cuộn', 'Đây là thông tin món bánh tráng cuộn', 10, 'uploads/FImages/banh_trang_cuon.png', 20000, 15000, 1),
(3, 'Bánh tráng nướng', 'info bánh tráng nướng', 10, 'uploads/FImages/banh_trang_nuong.png', 25000, 22000, 1),
(4, 'Bánh tráng trộn', 'info bánh tráng trộn', 10, 'uploads/FImages/banh_trang_tron.png', 30000, 25000, 1),
(5, 'Bắp xào', 'info bắp xào', 12, 'uploads/FImages/bap_xao.png', 15000, 13000, 1),
(6, 'Chân gà xả tắc', 'info chân gà xả tắc', 30, 'uploads/FImages/chan_ga_xa_tac.png', 25000, 21000, 1),
(7, 'Chuối chiên', 'info chuối chiên', 50, 'uploads/FImages/chuoi_chien.png', 10000, 7000, 1),
(8, 'Gỏi cuốn', 'info gỏi cuốn', 40, 'uploads/FImages/goi_cuon.png', 15000, 11000, 1),
(9, 'Hột vịt lộn', 'info hột vịt lộn', 100, 'uploads/FImages/hot_vit_lon.png', 10000, 8000, 1),
(10, 'Bánh bèo', 'info bánh bèo', 50, 'uploads/FImages/banh_beo.png', 20000, 14000, 1),
(11, 'Bánh canh cua', 'info bánh canh cua', 35, 'uploads/FImages/banh_canh_cua.png', 20000, 18000, 1),
(12, 'Bánh cuốn', 'info bánh cuốn', 45, 'uploads/FImages/banh_cuon.png', 25000, 20000, 1),
(13, 'Bánh đa', 'info bánh đa', 30, 'uploads/FImages/banh_da.png', 10000, 7000, 1),
(14, 'Bánh đúc', 'info bánh đúc', 50, 'uploads/FImages/banh_duc.png', 15000, 12000, 1),
(15, 'Bánh hỏi', 'info bánh hỏi', 20, 'uploads/FImages/banh_hoi.png', 20000, 18000, 1),
(16, 'Bánh tằm', 'info bánh tằm', 30, 'uploads/FImages/banh_tam.png', 20000, 15000, 1),
(17, 'Bánh xèo', 'info bánh xèo', 25, 'uploads/FImages/banh_xeo.png', 15000, 11000, 1),
(18, 'Bún bò', 'info bún bò', 50, 'uploads/FImages/bun_bo.png', 40000, 30000, 1),
(19, 'Bún chả Hà Nội', 'info bún chả Hà Nội', 35, 'uploads/FImages/bun_cha_ha_noi.png', 50000, 45000, 1),
(20, 'Bún đậu mắm tôm', 'info bún đậu mắm tôm', 45, 'uploads/FImages/bun_dau_mam_tom.png', 35000, 31000, 1),
(21, 'Bún mắm', 'info bún mắm', 20, 'uploads/FImages/bun_mam.png', 30000, 23000, 1),
(22, 'Bún mộc', 'info bún mộc', 15, 'uploads/FImages/bun_moc.png', 20000, 16000, 1),
(23, 'Bún ốc', 'info bún ốc', 30, 'uploads/FImages/bun_oc.png', 30000, 24000, 1),
(24, 'Bún riêu', 'info bún riêu', 35, 'uploads/FImages/bun_rieu.png', 25000, 22000, 1),
(25, 'Bún thịt nướng', 'info bún thịt nướng', 23, 'uploads/FImages/bun_thit_nuong.png', 30000, 25000, 1),
(26, 'Chè thái', 'info chè thái', 30, 'uploads/FImages/che_thai.png', 15000, 11000, 2),
(27, 'Dừa dằm', 'info dừa dằm', 20000, 'uploads/FImages/dua_dam.png', 20000, 14000, 2),
(28, 'Milo dằm', 'info milo dằm', 60, 'uploads/FImages/milo_dam.png', 20000, 14000, 2),
(29, 'Nước ép cam', 'info nước ép cam', 40, 'uploads/FImages/nuoc_ep_cam.png', 15000, 10000, 2),
(30, 'Sữa chua nếp cẩm', 'info sữa chua nếp cẩm', 30, 'uploads/FImages/sua_chua_nep_cam.png', 25000, 20000, 2),
(31, 'Sữa tươi trân châu', 'info sữa tươi chân châu', 30, 'uploads/FImages/sua_tuoi_tran_chau_duong_den.png', 30000, 20000, 2),
(32, 'Trà đào', 'info trà đào', 30, 'uploads/FImages/tra_dao.png', 15000, 10000, 2),
(33, 'Trà sữa trân châu', 'info trà sữa trân châu', 50, 'uploads/FImages/tra_sua_tran_chau.png', 25000, 19000, 2);
